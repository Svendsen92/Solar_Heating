...
void* appControl::aControl(void *a){
    ...
    while (true){
        ...
        if (state == "login"){
            ...
            tcp.sendMsg(act.dayStatsActivity(timeStamp, solarTemp, houseTemp, convexIn, convexOut, kWh));    
            tcp.closeConn();
            ...
            tcp.sendMsg(act.weekStatsActivity(timeStamp, solarTemp, houseTemp, convexIn, convexOut, kWh));    
            tcp.closeConn();
